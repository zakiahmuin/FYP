...
<head>
    ...
    <title>Registration Educator</title>
</head>
<style>
        body.bg {
...
<body class="bg">
    <div class="form"></div>
        ...
        <form  class="box" action="addEducator.php" method="POST" enctype="multipart/form-data">
    ...
    $image_folder = 'uploaded_img/' . $image;
        ...
        $select = "SELECT * FROM approve WHERE email = '$email'";
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            $register = "INSERT INTO approve (unique_id, name, username, email, password, gender, age, phone, university, education_level, preference_type, method, availability, description, image, status) VALUES ('$ran_id','$name','$username', '$email', '$password','$gender', '$num', '$phone', '$university', '$education_level', '$preference_type', '$method', '$availability', '$description', '$image', 'pending')";
