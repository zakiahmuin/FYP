                 ...
                 <table class='table table-bordered table-striped'>
                    ...
                    while ($row = mysqli_fetch_assoc($res)) {
                        echo "<tr>
                                ...
                                <td>".$row['preference_type']."</td>
                                <td>
                                <a class='btn btn-outline-danger' href='deleteEducator.php?id=".$row['id']."'>Delete</a>
                            </td>   
                              </tr>";
                    }
                    echo "</table>";
            ...
            <table class="table table-data2">
                ...
                <tbody>
                    ...
                    <tr class="tr-shadow">                                              
                        ...
                        <td class="text-center"><?=$row['preference_type'];?></td>
                                                                   
                        <td class="text-center">

                            <a type="button" class="btn btn-outline-danger" href='deleteEducator.php?id=<?=$row['id'];?>'>Delete</a>
                        </td>                                                            
                    </tr>
                    <tr class="spacer"></tr>                                                                                                                          
                    <?php 
