            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <div class="account-dropdown">
                        <a href="viewStudentaccount.php"><i class="zmdi zmdi-account"></i>Account</a>
                    </div>
                    <div class="account-dropdown">
    ...
    <div class="container">   
        <form method="POST" action="">
            <div class="search-container">
                ...
                <select name="method">
                    <option value="">Select Method Learning</option>
                    <option value="online">Online</option>
                    <option value="Face-to-face">Fcae-to-face</option>
...
if (isset($_POST['search'])) {
    ...
    $preference_type = isset($_POST['preference_type']) ? $_POST['preference_type'] : '';
    $method = isset($_POST['method']) ? $_POST['method'] : '';
    $availability = isset($_POST['availability']) ? $_POST['availability'] : '';

    $query = "SELECT * FROM approve WHERE 1=1";
    ...
    if (!empty($preference_type)) {
        $query .= " AND preference_type = '$preference_type'";
    }
    if (!empty($method)) {
    ...
    if (mysqli_num_rows($res) > 0) {
        echo "<h4 class='educator'>Lists of Educator</h4>
              <div class='t'>
        ...
        while ($row = mysqli_fetch_assoc($res)) {
            echo "<div class='student-info'>
                  ...
                  <p>Type Special Needs: " . htmlspecialchars($row['preference_type']) . "</p>
                  <p>Method Learning: " . htmlspecialchars($row['method']) . "</p>
...
<div class="t">
    ...
    <div class="student-info">
        <div class="student-details">
            ...
            <p>Age: <?=$row['age'];?></p>
            <p>Type Special Needs: <?=$row['preference_type'];?></p>
            <p>Method Learning: <?=$row['method'];?></p>
